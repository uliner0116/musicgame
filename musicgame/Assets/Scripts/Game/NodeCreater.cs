...
namespace Game
{
    public class NodeCreater : MonoBehaviour
    {
        ...
        void Awake()
        {
           ...
           destination = GameObject.Find(nodeParent.name + "/baseLne");
        ...
        void nodeCreate()
        {
            ...
            var node = Instantiate(Node, nodeParent.transform);
            ...
            node.transform.localScale = new Vector3(0.7719f, 0.8685f, -0.0062586f);
        }
    }
}